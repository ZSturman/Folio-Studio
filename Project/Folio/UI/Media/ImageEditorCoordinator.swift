...
//
//  DEPRECATED: This coordinator for opening standalone editor windows has been replaced
//  with integrated editing in the Media tab. Image editing now happens via the inspector panel.
